...
print("How good is the test good sentence?", good_good) # 0.36595991253852844
print("How bad is the test good sentence?", good_bad) # 0.24264846742153168
print("Test good sentence is most likely '{}'.".format("good" if good_good > good_bad else "bad")) # 'good'
print("How bad is the test bad sentence?", bad_bad) # 0.17468978464603424
print("How good is the test bad sentence?", bad_good) # 0.14713899791240692
print("Test bad sentence is most likely '{}'.".format("bad" if bad_bad > bad_good else "good")) # 'bad'
```
